		...
		for(int i=0; i<answer.size(); i++) {
			...
			if(stuff == 0) {
				...
				for(int j=0; j<answer.size(); j++) {
					...
					else if(x == answer.get(j).get(0) && y == answer.get(j).get(1) && 1 == answer.get(j).get(2)) {
						check = true;
					}
					else if(x == answer.get(j).get(0) && y-1 == answer.get(j).get(1) && 0 == answer.get(j).get(2)) {
						check = true;
					}
				}
				...
				for(int j=0; j<answer.size(); j++) {
					...
					else if(x+1 == answer.get(j).get(0) && y-1 == answer.get(j).get(1)&& 0 == answer.get(j).get(2)) {
						check = true;
					}
					else if(x-1 == answer.get(j).get(0) && y == answer.get(j).get(1)&& 1 == answer.get(j).get(2) ) {
						left = true;
					}
					else if(x+1 == answer.get(j).get(0) && y == answer.get(j).get(1)&& 1 == answer.get(j).get(2)) {
						right = true;
